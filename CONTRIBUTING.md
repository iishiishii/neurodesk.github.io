...
```bash
wget https://github.com/gohugoio/hugo/releases/download/v0.161.1/hugo_extended_0.161.1_Linux-64bit.tar.gz
tar xfz hugo_extended_0.161.1_Linux-64bit.tar.gz
